...
<img
  src="https://github.com/azaek/cntrl/blob/main/github.png?raw=true"
  alt="Cover"
  className="hidden dark:block"
/>
<img
  src="https://github.com/azaek/cntrl/blob/main/github-light.png?raw=true"
  alt="Cover"
  className="mt-0 block dark:hidden"
/>

Welcome to **Cntrl Bridge**.
