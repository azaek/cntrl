...
<Callout title="Storage Support">
  By default, bridges are persisted to localStorage via Zustand. You can plug in a custom storage backend (IndexedDB, SQLite, REST API) — see [Custom Storage](/docs/sdk/custom-persistence).
</Callout>
