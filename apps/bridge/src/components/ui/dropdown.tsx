  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          "animate-content-hide bg-card data-expanded:animate-content-show z-50 min-w-32 origin-(--kb-menu-content-transform-origin) overflow-hidden rounded-xl border p-1 text-neutral-300 shadow-md outline-none",
          props.class,
        )}
        {...rest}
      />
...
const DropdownMenuItem = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.Item
      class={cn(
        "relative flex cursor-default items-center gap-2 rounded-md px-2 py-1.5 text-sm transition-colors outline-none select-none focus:bg-neutral-700/20 focus:text-neutral-300 data-disabled:pointer-events-none data-disabled:opacity-50",
        props.class,
      )}
      {...rest}
    />
...
const DropdownMenuLabel: Component<ComponentProps<"div"> & { inset?: boolean }> = (
  ...
  return (
    <div
      class={cn(
        "px-1 py-1 text-[10px] font-medium text-neutral-500 uppercase",
        props.inset && "pl-8",
        props.class,
      )}
      {...rest}
