...
const SelectTrigger = <T extends ValidComponent = "button">(
    ...
    return (
        <SelectPrimitive.Trigger
            class={cn(
                "border-input ring-offset-background placeholder:text-muted-foreground focus:ring-ring flex h-10 w-full items-center justify-between rounded-md border bg-transparent px-3 py-2 text-sm focus:ring-2 focus:ring-white/5 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50",
                local.class,
            )}
            {...others}
        >
...
const SelectItem = <T extends ValidComponent = "li">(
    ...
    return (
        <SelectPrimitive.Item
            class={cn(
                "focus:bg-card focus:text-accent-foreground relative mt-0 flex w-full cursor-default items-center rounded-sm py-1.5 pr-8 pl-2 text-sm outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
                local.class,
            )}
            {...others}
        >
