...
const TextFieldInput = <T extends ValidComponent = "input">(
  ...
  return (
    <TextFieldPrimitive.Input
      type={local.type}
      class={cn(
        "bg-input data-invalid:border-error-foreground data-invalid:text-error-foreground flex h-8 w-full rounded-lg border px-2 py-2 text-sm ring-offset-neutral-900 file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-600 focus-visible:ring-2 focus-visible:ring-neutral-800 focus-visible:ring-offset-0 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        local.class,
      )}
      {...others}
    />
