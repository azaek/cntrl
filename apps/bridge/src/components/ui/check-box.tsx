...
const Checkbox = <T extends ValidComponent = "div">(
  ...
  return (
    ...
    >
      ...
      <CheckboxPrimitive.Control class="peer-focus-visible:ring-border size-4 shrink-0 rounded-sm border border-neutral-500 peer-focus-visible:ring-1 peer-focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 data-[checked]:border-none data-[checked]:bg-neutral-50 data-[checked]:text-neutral-900 data-[indeterminate]:border-none data-[indeterminate]:bg-neutral-300 data-[indeterminate]:text-neutral-800">
