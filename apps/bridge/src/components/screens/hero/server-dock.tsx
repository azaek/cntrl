            ...
            <div class="flex items-center gap-2">
                <div
                    class={cn(
                        ...
                        store.status?.status.status === "Stopped" && "bg-neutral-200",
                            ...
                            <EthernetPort
                                class={cn(
                                    ...
                                    store.status?.status.status === "Error" &&
                                        "text-red-500",
                                    store.status?.status.status === "Running" &&
                                        "text-accent",
                ...
                <Show when={store.status?.status.status === "Running"} fallback={null}>
                    ...
                    >
                        ...
                        >
                            <Show
                                when={stoppingServer()}
                                fallback={<CircleStop class="size-3.5" />}
                            >
                ...
                >
                    ...
                    >
                        <Show
                            ...
                            fallback={
                                <Show
                                    when={refreshingServer()}
                                    fallback={<RefreshCw class="size-3.5" />}
                                >
                                    <Loader class="size-3.5 animate-spin" />
                                </Show>
                            }
