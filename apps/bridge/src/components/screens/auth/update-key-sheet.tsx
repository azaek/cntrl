  ...
  return (
    <Drawer open={props.open} onOpenChange={props.onOpenChange}>
      <DrawerContent>
        ...
        <UpdateKeySheetScreen apiKey={props.apiKey} onOpenChange={props.onOpenChange} />
      </DrawerContent>
    </Drawer>
  );
};
      ...
      <div class="flex w-full flex-col gap-2 px-2">
        <div class="flex w-full items-center gap-2 px-2 py-3">
          ...
          <div class="flex flex-1 items-center justify-between">
            ...
            <p class="text-end font-mono text-sm font-semibold">...{props.apiKey.hint}</p>
          </div>
        </div>
                ...
                <Checkbox
                  ...
                  onChange={(c) => {
                    if (c) {
                      ...
                      setScopes((prev) => prev.filter((scope) => scope !== "ws:connect"));
                    }
                  }}
                />
                Allow
                  ...
                  <Checkbox
                    ...
                    onChange={(c) => {
                      if (c) {
                        ...
                        setScopes((prev) => prev.filter((scope) => scope !== "admin"));
                      }
                    }}
                  />
                  Allow
          ...
          <div class="mt-2 flex w-full flex-col items-start justify-between gap-2 border-y px-2 pt-2 pb-3">
            <div class="flex w-full items-center justify-between">
              <TextTip
                ...
                side="top"
              >
                <p class="text-sm font-medium underline decoration-dotted">Expires in</p>
              </TextTip>
