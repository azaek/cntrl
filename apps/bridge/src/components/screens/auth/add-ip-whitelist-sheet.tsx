...
import { addAllowedIp, getAuthInfo } from "../../../lib/auth";
        ...
        <Drawer open={open()} onOpenChange={setOpen}>
            ...
            <DrawerContent>
                <DrawerHeader class="sr-only">
                    <DrawerTitle>Allow IP Address</DrawerTitle>
                    <DrawerDescription>
                        Allow IP address to bypass authentication
                    </DrawerDescription>
                </DrawerHeader>
...
const AddIpWhiteListScreen = (props: { onClose: () => void }) => {
    ...
    return (
        <div class="mt-3 flex w-full flex-col px-3 pb-3">
            <p class="text-sm font-semibold">Whitelist IP Address</p>
            <p class="text-muted-foreground text-xs">
                Allow an IP address to bypass authentication.
            </p>
...
export default AddIpWhitelistSheet;
